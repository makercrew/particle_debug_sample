...
// Modified by Kevin Sidwar 2018 to prevent access to D6 and D7 for debug
// sample purposes. http://www.kevinsidwar.com
...
int tinkerDigitalRead(String pin)
{
    ...
    // D6 and D7 are off limits due to debugging
